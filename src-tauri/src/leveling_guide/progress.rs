...
const LEVELING_GUIDE_KEY: &str = "leveling_guide";
...
pub(crate) fn load_leveling_guide_progress(
    ...
    let maybe_progress = store::get_optional::<PersistedLevelingGuideProgress>(app, LEVELING_GUIDE_KEY)?;
...
pub(crate) fn save_leveling_guide_progress(
    ...
    store::set_value(app, LEVELING_GUIDE_KEY, progress)
}
